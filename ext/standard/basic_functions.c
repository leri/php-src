...
ZEND_BEGIN_ARG_INFO_EX(arginfo_combine_url, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, parts, 0)
	ZEND_ARG_INFO(0, ip_version)
	ZEND_ARG_INFO(0, enc_type)
ZEND_END_ARG_INFO()
...
const zend_function_entry basic_functions[] = { /* {{{ */
	...
	PHP_FE(combine_url,														arginfo_combine_url)
...
PHP_MINIT_FUNCTION(basic) /* {{{ */
{
	...
	REGISTER_LONG_CONSTANT("PHP_URL_IPv4", PHP_URL_IPv4, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("PHP_URL_IPv6", PHP_URL_IPv6, CONST_CS | CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("PHP_URL_SCHEME_KEY", PHP_URL_SCHEME_KEY, CONST_CS | CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("PHP_URL_HOST_KEY", PHP_URL_HOST_KEY, CONST_CS | CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("PHP_URL_PORT_KEY", PHP_URL_PORT_KEY, CONST_CS | CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("PHP_URL_USER_KEY", PHP_URL_USER_KEY, CONST_CS | CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("PHP_URL_PASS_KEY", PHP_URL_PASS_KEY, CONST_CS | CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("PHP_URL_PATH_KEY", PHP_URL_PATH_KEY, CONST_CS | CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("PHP_URL_QUERY_KEY", PHP_URL_QUERY_KEY, CONST_CS | CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("PHP_URL_FRAGMENT_KEY", PHP_URL_FRAGMENT_KEY, CONST_CS | CONST_PERSISTENT);
